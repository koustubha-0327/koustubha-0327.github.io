...
function scrambledString(tag, objName, initScrambledString, initScrambledStringIndices, displayText) {
    this.tag = tag;
    ...
    this.rescramble();
    this.tag.innerHTML = '<span onClick="' + this.objName + '.initAnimatedBubbleSort();return false;">' + this.displayText + '</span>';
}
